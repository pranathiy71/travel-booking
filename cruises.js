...
function displayCruiseInfo(){
    ...
    const numPass = document.getElementById("pass").value;
    const rooms = Math.ceil(numPass/2);
    ...
    `<p><b>Number of Passengers: </b> ${numPass}</p>` + `<p><b>Number of Rooms: </b> ${rooms}</p>`;
}
...
function checkCruiseForm(){
    ...
    let passErr = document.getElementById("passengerror");
